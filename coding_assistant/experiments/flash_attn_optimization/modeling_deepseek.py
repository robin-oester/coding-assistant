...
class DeepseekV2FlashAttention2(DeepseekV2Attention):
    ...
    def forward(
        ...
        # TODO: somehow check the name of the cache that is provided.
        # If FlashAttentionCache, execute this method, otherwise use the old forward()
        if past_key_value.__class__.__name__ == "FlashAttentionCache":
